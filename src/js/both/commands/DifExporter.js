...
/**
 * This exporter produces DIF (data interchange format) files for the supplied data.
 */
Ext.define('Tualo.exporter.text.DIF', {
...
Ext.define('Tualo.commands.DIFExporter', {
    statics: {
        glyph: 'file',
        title: 'DIF exportieren'
    },
    extend: 'Ext.panel.Panel',
    alias: 'widget.tualo_dif_exporter',
    requires: [
    ...
    items: [
        {
            ...
            items: [
                {
                    xtype: 'label',
                    text: 'Klicken Sie auf exportieren, um die aktuelle Ansicht der Liste als DIF abzurufen. Achtung es werden nur die geladenen Zeilen exportiert, vergrößern Sie ggf. die Zeilenanzahl.',
                }
            ]
        }
    ],
