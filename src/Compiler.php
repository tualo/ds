...
class Compiler implements ICompiler
{
    ...
    public static function getDynamicFiles()
    {
        ...
        if (!is_null($db)) {
            ...
            $subfiles = array_merge($subfiles, self::extractFiles('view_ds_field_model', '', 1));
            $subfiles = array_merge($subfiles, self::extractFiles('view_ds_store', '', 2));
            $subfiles = array_merge($subfiles, self::extractFiles('view_ds_field_store', '', 2));
            ...
            $subfiles = array_merge($subfiles, self::extractFiles('view_ds_displaylinkedfield', '', 3));
